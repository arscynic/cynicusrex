...
<div class="comment-meta">
  ...
  <div class="comment-author">
    ...
    <div class="comment-date" title="Date: year/month/day, 24-hour format."><a href="${reply.url}" rel="nofollow">Posted at ${reply.created_date.toLocaleString(/* navigator.language */"en-ZA", dateOptions)}</a>.</div>
  </div>
</div>
